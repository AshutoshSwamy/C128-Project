...
time.sleep(10)
headers = ["stars", "constellation", "right_accession", "declination", "app_mag", "distance", "spectral_type", "brown_dwarf", "mass", "radius", "orbital_period", "semimajor_axis", "ecc", "discovery_date", "hyperlink"]
planet_data = []
new_planet_data = []
def scrape():
    for i in range(1, 430):
        while True:
            ...
            if current_page_num < i:
                ...
                break
        for tr_tag in soup.find_all("tr", attrs={"class", "brown_dwarf"}):
